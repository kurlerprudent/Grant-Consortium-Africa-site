...
export const metadata: Metadata = {
  ...
  keywords: ["Grant Consortium Africa", "African development", "development organization", "Africa", "grants", "consortium"],
  authors: [{ name: "Grant Consortium Africa" }],
  creator: "Grant Consortium Africa",
  publisher: "Grant Consortium Africa",
  metadataBase: new URL("https://grantconsortiumafrica.org"), // Replace with actual domain
  openGraph: {
    title: "Grant Consortium Africa | Empowering African Development",
    description: "Leading development organization fostering sustainable growth across Africa",
    type: "website",
    locale: "en_US",
