      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid lg:grid-cols-2 gap-8">
          ...
          <div className="bg-white rounded-2xl shadow-lg overflow-hidden">
            <a 
              href="https://maps.app.goo.gl/4BNDxkAaCLzLdJab7" 
              target="_blank" 
              rel="noopener noreferrer"
              className="block"
            >
              <div className="bg-gradient-to-br from-blue-500 to-purple-600 h-96 flex items-center justify-center relative cursor-pointer">
            ...
            <div className="bg-white rounded-2xl shadow-lg p-8">
              ...
              <div className="grid grid-cols-2 gap-4">
                <a 
                  ...
                  target="_blank" 
                  rel="noopener noreferrer"
                  className="flex items-center justify-center px-4 py-3 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors font-body"
                >
